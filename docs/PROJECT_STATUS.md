...
- **Doğrulanamayan:** SYSTEM bağlamında P:\ görünmezliğinin birebir ampirik kanıtı bu geliştirme ortamında yönetici yükseltmesi bulunmadığı için alınamadı (çok yüksek güvenle aynı sonuca işaret eden gözlem + resmi Microsoft davranış belgesi mevcut). Ofis makinesinde Adım 2.5 olarak ilk gerçek çalıştırma bunu kesinleştirmelidir.
