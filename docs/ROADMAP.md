...
| v0.6 — E-posta | AI taslak, Gmail ekranı, ek önerileri, dosya geçmişi; ileride Gmail API | **Çekirdek tamamlandı:** deterministik kullanıcı kontrollü taslak, verified ek önerisi, sürüm geçmişi ve `not_sent` Gmail web handoff mevcut; AI taslak ve gelen e-posta/Gmail API bekliyor |
...
Paket 41 kullanıcı kontrollü e-posta taslak çekirdeği tamamlandı. Sonraki mantıklı adım Paket 42’de mevcut provider/PII/bütçe kapılarını kullanan kanıtlı AI e-posta taslak önerisidir; Paket 41 commit edilmeden başlatılmaz.
