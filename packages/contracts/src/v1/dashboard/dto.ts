...
export const dashboardCaseItemSchema = z.strictObject({
  ...
  openTaskCount: boundedCountSchema,
  overdueTaskCount: boundedCountSchema,
  dueTodayTaskCount: boundedCountSchema,
  upcomingTaskCount: boundedCountSchema,
...
export const dashboardSummarySchema = z.strictObject({
  ...
  openTaskCount: boundedCountSchema,
  overdueTaskCaseCount: boundedCountSchema,
  taskDueTodayCaseCount: boundedCountSchema,
  upcomingTaskCaseCount: boundedCountSchema,
