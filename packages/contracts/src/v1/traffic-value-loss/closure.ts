...
import { trafficValueLossMoneyMinorSchema, trafficValueLossUuidSchema } from './commands.js'
...
export const trafficValueLossClosureSummarySchema = z.strictObject({
  ...
  assessmentId: trafficValueLossUuidSchema.nullable(),
  assessmentVersionId: trafficValueLossUuidSchema.nullable(),
  ...
  reportId: trafficValueLossUuidSchema.nullable(),
