...
const EXPECTED_NAMES: readonly JsonSchemaName[] = [
  ...
  'labor-excel-profile-candidates-response',
  'labor-excel-profile-save-request',
  'labor-excel-profile-status-request',
  'labor-excel-profiles-response',
  'labor-excel-projection-response',
  'labor-sheet-create-request',
  'labor-sheet-response',
  'labor-sheet-revise-request',
  'labor-sheet-workspace-response',
  'labor-workbook-apply-approve-request',
  'labor-workbook-apply-preview-request',
  'labor-workbook-apply-response',
  ...
  'traffic-value-loss-current-approved-response',
  'traffic-value-loss-part-catalog-response',
  'traffic-value-loss-preview-request',
  'traffic-value-loss-preview-response',
