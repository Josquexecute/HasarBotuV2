...
describeDb('PostgreSQL entegrasyonu (gercek veritabani)', () => {
  ...
  it('0036 geri alınabilir ve yeniden ileri uygulanabilir', async () => {
    ...
    expect(rolledBack.map((migration) => migration.name)).toEqual(['0040_labor_category_persistence', '0039_labor_allocation_schema_v2', '0038_labor_excel_profile_categories', '0037_labor_excel_profile_selection', '0036_labor_allocation_progress'])
    ...
    expect(reapplied.map((migration) => migration.name)).toEqual(['0036_labor_allocation_progress', '0037_labor_excel_profile_selection', '0038_labor_excel_profile_categories', '0039_labor_allocation_schema_v2', '0040_labor_category_persistence'])
  })
  ...
  it('0035 geri alınabilir ve yeniden ileri uygulanabilir', async () => {
    ...
    expect(rolledBack.map((migration) => migration.name)).toEqual(['0040_labor_category_persistence', '0039_labor_allocation_schema_v2', '0038_labor_excel_profile_categories', '0037_labor_excel_profile_selection', '0036_labor_allocation_progress', '0035_labor_excel_profiles'])
    const removed = await pool.query(
    ...
    expect(removed.rows).toEqual([{ n: 0 }])
    const reapplied = await runMigrations({ databaseUrl: config.url, quiet: true })
    expect(reapplied.map((migration) => migration.name)).toEqual(['0035_labor_excel_profiles', '0036_labor_allocation_progress', '0037_labor_excel_profile_selection', '0038_labor_excel_profile_categories', '0039_labor_allocation_schema_v2', '0040_labor_category_persistence'])
  })
  ...
  it('0034 geri alınabilir ve yeniden ileri uygulanabilir', async () => {
    ...
    expect(rolledBack.map((migration) => migration.name)).toEqual(['0040_labor_category_persistence', '0039_labor_allocation_schema_v2', '0038_labor_excel_profile_categories', '0037_labor_excel_profile_selection', '0036_labor_allocation_progress', '0035_labor_excel_profiles', '0034_labor_allocation_application'])
    const removed = await pool.query(
      `SELECT count(*)::int AS n FROM information_schema.tables
    ...
    expect(removed.rows).toEqual([{ n: 0 }])
    const reapplied = await runMigrations({ databaseUrl: config.url, quiet: true })
    expect(reapplied.map((migration) => migration.name)).toEqual(['0034_labor_allocation_application', '0035_labor_excel_profiles', '0036_labor_allocation_progress', '0037_labor_excel_profile_selection', '0038_labor_excel_profile_categories', '0039_labor_allocation_schema_v2', '0040_labor_category_persistence'])
  })
