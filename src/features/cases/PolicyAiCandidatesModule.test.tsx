...
describe('AI alan adayları görünümü', () => {
  it('açık onay sonrası start çalıştırır; bundle, conflict, anchor ve doğru OCR uyarısını gösterir', async () => {
    ...
    expect(screen.getByText(/accept, edit, reject/)).toBeInTheDocument()
