          ...
          {report !== null && (
            <>
              <section className="metric-strip" aria-label="Gerçek rapor özeti">
                ...
                <div><span>Ücret Kontrolü Bekleyen</span><strong>{report.summary.controlRequiredFeeCount}</strong><small>{report.summary.closedCaseWithoutFeeCount} kayıtsız kapalı dosya</small></div>
              </section>
              <div className="reports-grid">
                ...
                <section className="info-panel"><header><h2>Ücret Durumu</h2><span>{report.period}</span></header><dl className="detail-list"><div><dt>Kullanıcı Onaylı</dt><dd>{formatCurrency(report.summary.approvedFeeTotalMinor / 100)}</dd></div><div><dt>Kontrol Bekliyor</dt><dd>{report.summary.controlRequiredFeeCount} dosya</dd></div><div><dt>Ücret Kaydı Yok</dt><dd>{report.summary.closedCaseWithoutFeeCount} dosya</dd></div><div><dt>Kural</dt><dd>closure-fee/1.0.0</dd></div></dl></section>
              </div>
